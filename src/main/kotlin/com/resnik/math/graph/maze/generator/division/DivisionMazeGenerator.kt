...
open class DivisionMazeGenerator(params: MazeParameterInterface, val numDivide: Int = 1) : MazeGenerator(params) {
    ...
    class MazeDivision(
        val splitDirection: RelativeDirection,
        ...
        fun split(): MazeSplit? {
            ...
            val nextDirection =
                if (splitDirection == RelativeDirection.VERTICAL) RelativeDirection.HORIZONTAL else RelativeDirection.VERTICAL
            ...
            if (nextDirection == RelativeDirection.VERTICAL) {
                ...
                * */
                ...
                return MazeSplit(
                    MazeDivision(nextDirection, leftBBox, divisionLine, indexGenerator = indexGenerator),
                    MazeDivision(nextDirection, rightBBox, divisionLine, indexGenerator = indexGenerator)
                )
            } else {
                /*
                * UP
                ...
                * */
                ...
                return MazeSplit(
                    MazeDivision(nextDirection, topBBox, divisionLine, indexGenerator = indexGenerator),
                    MazeDivision(nextDirection, bottomBBox, divisionLine, indexGenerator = indexGenerator)
                )
            }
        }
    }
    ...
    override fun build(): Maze {
        ...
        val startDivision = MazeDivision(
            RelativeDirection.HORIZONTAL,
            bbox,
            startDivisionLine,
            indexGenerator = { a, b -> indexGenerator(a, b) })
